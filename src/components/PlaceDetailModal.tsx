    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Confirm Delete Banner (Header level) */}
          {confirmDelete && (
            <div className="px-5 py-3 bg-rose-50 border-b border-rose-200 flex items-center justify-between animate-in fade-in text-xs">
              <span className="font-bold text-rose-800 flex items-center gap-1.5">
                <AlertCircle className="w-4 h-4 text-rose-600 shrink-0" />
                <span>Vuoi eliminare definitivamente "{placeName}"?</span>
              </span>
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="px-3 py-1 rounded-lg bg-rose-600 hover:bg-rose-700 text-white font-bold"
                >
                  Elimina
                </button>
              </div>
