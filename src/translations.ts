...
export const TRANSLATIONS: Record<LanguageCode, TranslationDictionary> = {
  it: {
    ...
    loginText: "Accedi con la tua email per sincronizzare i tuoi luoghi e note su tutti i dispositivi.",
  ...
  en: {
    ...
    loginText: "Sign in with your email to sync your places and notes across all your devices.",
  ...
  de: {
    ...
    loginText: "Melde dich mit deiner E-Mail an, um Orte geräteübergreifend zu synchronisieren.",
    loginButton: "Mit Account anmelden",
  ...
  fr: {
    ...
    loginText: "Connectez-vous avec votre email pour synchroniser vos lieux sur tous vos appareils.",
    loginButton: "Connexion à votre compte",
  ...
  es: {
    ...
    loginText: "Inicia sesión con tu email para sincronizar tus lugares en todos tus dispositivos.",
